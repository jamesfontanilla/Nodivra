...
Fresh build of Nodivra Pages, Blocks, Projects, Path, Notes, Talks, Snips, Work, and Inbox: a polished public profile and safe, flexible page builder for developers.
...
- Inbox is a private, owner-only contact queue for public profile messages. It accepts bounded plain-text inquiries without accounts, stores optional service/project context, supports unread/read/archived/replied/spam states, and does not send email, SMS, or calendar invites.
